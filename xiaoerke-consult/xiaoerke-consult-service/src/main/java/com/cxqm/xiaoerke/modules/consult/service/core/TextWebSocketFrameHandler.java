...
public class TextWebSocketFrameHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx,
        ...
        if (sessionId != null) {
            sessionIdNotNull(msg, msgMap, sysPropertyVoWithBLOBsVo, sessionId, msgType, userWechatParam);
        } else if (sessionId == null) {
            sessionIdIsNull(channel, msgMap, msgType);
        }
    }

    private void sessionIdIsNull(Channel channel, Map<String, Object> msgMap, int msgType) {
    ...
    private void sessionIdNotNull(TextWebSocketFrame msg, Map<String, Object> msgMap, SysPropertyVoWithBLOBsVo sysPropertyVoWithBLOBsVo, Integer sessionId, int msgType, Map userWechatParam) {
