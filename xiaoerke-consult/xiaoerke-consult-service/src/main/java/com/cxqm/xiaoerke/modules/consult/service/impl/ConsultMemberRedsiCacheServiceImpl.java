...
public class ConsultMemberRedsiCacheServiceImpl implements ConsultMemberRedsiCacheService {
    ...
    public void payConsultMember(String openid, String timeLength, String totalFee, String token) {
        ...
        do{
            ...
            LogUtils.saveLog("更新reids会员时间",DateUtils.DateToStr(consultMemberVo.getEndTime(), "datetime"));
            try {
                Thread.sleep(1000l);
        ...
        LogUtils.saveLog("reids会员时间更新成功",DateUtils.DateToStr(consultMemberVo.getEndTime(), "datetime"));
