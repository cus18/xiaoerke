        ...
        if (file != null && !file.isEmpty()) {
            ...
            try {
                ...
                try {
                    ...
                    String key = null;
                    String aliUrl = null;
                    if (msgMap.get("sessionId") == null || StringUtils.isNull(String.valueOf(msgMap.get("sessionId")))) {
                        if (("image").equalsIgnoreCase(fileType) || ("1").equalsIgnoreCase(fileType)) {
                            ...
                            if (user != null) {
                                ...
                                if (StringUtils.isNotNull(userType) && ("distributor".equalsIgnoreCase(userType) || "consultDoctor".equalsIgnoreCase(userType))) {
                                    ...
                                    response.put("source", msgMap.get("source"));
                                } else {
                        ...
                        sessionId = Integer.valueOf(String.valueOf(msgMap.get("sessionId")));
