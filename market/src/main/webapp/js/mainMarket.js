...
require.config({
    ...
    paths: {
        ...
        "marketFactory" : "services/marketFactory",
        "marketDirective" : "directives/marketDirective",
        "appMarketRoute" : "routes/appMarketRoute",
        "appMarket" : "modules/appMarket"
    },
    waitSeconds: 0,
    shim: {
        'angular': {
...
require(['angular','angular-resource','angular-sanitize','angular-route',
    'ocLazyLoad','jquery','marketFactory','marketDirective','appMarketRoute','appMarket'],
    function (angular){
