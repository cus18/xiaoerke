...
public class MemberServiceImpl implements MemberService {
    ...
    public void sendMemberURLMessage(String openid) {
        ...
        String st = "感谢您对宝大夫的关注，宝大夫现对新用户推出周会员免费体验服务！\n" +
                "点击后登录并领取\n" +
                "【<a href='" + ConstantUtil.BAODF_URL + "/xiaoerke-appoint/ap/wechatInfo/fieldwork/wechat/author?url=" + ConstantUtil.BAODF_URL
                + "/xiaoerke-appoint/ap/wechatInfo/getUserWechatMenId?url=23'>查看详情</a>】\n ";
