...
public class PayNotificationController {
    ...
    public synchronized
    @ResponseBody
    String getCustomerPayNotifyInfo(HttpServletRequest request) {
        DataSourceSwitch.setDataSourceType(DataSourceInstances.WRITE);
    ...
    public synchronized
    @ResponseBody
    String getUmbrellaPayNotifyInfo(HttpServletRequest request) {
        DataSourceSwitch.setDataSourceType(DataSourceInstances.WRITE);
    ...
    public synchronized
    @ResponseBody
    String getLovePlanPayNotifyInfo(HttpServletRequest request, HttpSession session) {
        DataSourceSwitch.setDataSourceType(DataSourceInstances.WRITE);
