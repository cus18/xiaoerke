...
<body>
	...
	<form:form id="inputForm" modelAttribute="illnessVo" action="${ctx}/sys/illnessManage/illnessManagerImpl" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/>--%>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<%--<span class="help-inline">没有？请联系管理员</span>--%>
					<input id="level_1" name="level_1" type="text" value="${illnessVo.level_1}" class="required" />
			</div>
		</div>
		...
		<input id="id" name="id" type="hidden" value="${illnessVo.id}" class="required" />
