...
<head>
	...
	<script type="text/javascript">
		...
		function removeRegister(){
			var the_url = "${ctx}/register/operRegisterForm?sysDoctorId=${registerServiceVo.sysDoctorId}&locationId="+locationId+"&date="+date+"&time=${time}&operFlag=oper&delFlag=del";
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>修改号源</a></li>
		<li><a href="javascript:removeRegister()">删除号源</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="patientRegisterServiceVo" action="${ctx}/order/saveAppointment?sysRegisterServiceId=${registerId}" method="post" class="form-horizontal"><%--
		...
		<div class="control-group"  style="margin-left: -100px">
			<div class="controls" >
				...
				<label for="operCopy" >修改所有重复的号源</label>
			</div>
		</div>
	</form:form>
</body>
