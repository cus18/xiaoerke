...
<ul>
	...
	<li>列表</li>
	<li>
	<a  href="${pageContext.request.contextPath}/UrlDoctorForm">医生添加</a></li>
</ul>
<%--	<div id="importBox" class="hide">
	...
	<%--<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/admin/doctorManage/UrlDoctorList">医生列表</a></li>
		&lt;%&ndash;<shiro:hasPermission name="sys:user:edit">&ndash;%&gt;<li><a href="${ctx}/admin/doctorManage/UrlDoctorForm">用户添加</a></li>&lt;%&ndash;</shiro:hasPermission>&ndash;%&gt;
</ul>--%>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				...
				<td>${user.name}</td>
				<td>${user.phone}</td>
				<td>${user.mobile}</td>&lt;%&ndash;
				<td>${user.roleNames}</td> &ndash;%&gt;
	...
	<div class="pagination">${page}</div>&ndash;%&gt;dsdasd--%>
<table style="width: auto;border:1px solid #dddddd; ">
	...
	<c:forEach items="${page.list}" var="user">
	<tr>
		<td>${user.name}</td><td>${user.phone}</td><td>删除查看</td>
