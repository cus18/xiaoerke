...
<link href="${ctxStatic}/showDialog/showDialog.css" rel="stylesheet"/>
<script src="${ctxStatic}/showDialog/showDialog.js" type="text/javascript"></script>
<script src="${ctxStatic}/showDialog/registerShowDialog.js" type="text/javascript"></script>
<script src="${ctxStatic}/showDialog/jquery.min.js" type="text/javascript"></script>
