angular.module('controllers', ['ionic']).controller('EvaluateDoctorCtrl', [
        ...
        function ($scope,$state,$location,$stateParams,$filter,OrderPraiseOperation,FindDoctorCaseEvaluation,GetUserLoginStatus) {
            ...
            $scope.imgs1=[$scope.starImg1,$scope.starImg1,$scope.starImg1,$scope.starImg1,$scope.starImg1];
            $scope.imgs2=[$scope.starImg1,$scope.starImg1,$scope.starImg1,$scope.starImg1,$scope.starImg1];
            ...
            $scope.money = function(index){
                $(".money .r a").removeClass("cur");
                $(".money .r a").eq(index).addClass("cur")
            }
            ...
            $scope.removeImpress = function(index){
                $scope.ImpressionShow.splice(index,1);
            }
            $scope.change = function(){
                if($scope.lock == "0"){
                    $(".ion-thumbsup").addClass("color");
                    $scope.lock = "1"
                }
                else{
                    $(".ion-thumbsup").removeClass("color");
                    $scope.lock = "0"
                }
