angular.module('controllers', ['ionic']).controller('AppointmentCancelCtrl', [
    '$scope','GetUserLoginStatus','$state','$location', '$anchorScroll','MyselfInfoAppointmentDetail',
    'OrderCancelOperation','$stateParams',
        function ($scope,GetUserLoginStatus,$state,$location, $anchorScroll,MyselfInfoAppointmentDetail,
                  OrderCancelOperation,$stateParams) {
            $scope.title="取消预约";
