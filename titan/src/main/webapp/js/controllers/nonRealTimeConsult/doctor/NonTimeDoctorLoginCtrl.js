        ...
        $scope.doctorBindingAction = function () {
            doctorBinding.save({username: $scope.info.phoneNum, password: $scope.info.password}, function (data) {
                if (data.status == "failure") {
                    ...
                    window.location.href = "http://s251.baodf.com/keeper/wechatInfo/fieldwork/wechat/doctorAuthor?url=http://s251.baodf.com/keeper/wechatInfo/getDoctorWechatMenId?url=6";
                }
            });
        }
