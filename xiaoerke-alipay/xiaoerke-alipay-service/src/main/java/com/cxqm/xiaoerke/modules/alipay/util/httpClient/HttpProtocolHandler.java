...
public class HttpProtocolHandler {
    ...
    public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath) throws HttpException, IOException {
        ...
        //get模式且不带上传文件
        if (request.getMethod().equals(com.cxqm.xiaoerke.modules.alipay.util.httpClient.HttpRequest.METHOD_GET)) {
        ...
        try {
            ...
            if (request.getResultType().equals(com.cxqm.xiaoerke.modules.alipay.util.httpClient.HttpResultType.STRING)) {
                response.setStringResult(method.getResponseBodyAsString());
            } else if (request.getResultType().equals(com.cxqm.xiaoerke.modules.alipay.util.httpClient.HttpResultType.BYTES)) {
