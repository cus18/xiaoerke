angular.module('controllers', ['ionic']).controller('umbrellaLeadCtrl', [
    ...
    function ($scope,$state,$stateParams) {
        ...
        $scope.goJoin=function(index){
            ...
            window.location.href="http://s202.xiaork.com/keeper/wechatInfo/fieldwork/wechat/author?url=http://s202.xiaork.com/keeper/wechatInfo/getUserWechatMenId?url=umbrellaa_"+ $stateParams.id;
        };
                    ...
                    if(data!=null ){
                        ...
                        wx.ready(function () {
                            ...
                            wx.onMenuShareTimeline({
                                ...
                                link: "http://s202.xiaork.com/wisdom/umbrella#/umbrellaLead/"+$stateParams.id+"/"+$stateParams.status,
